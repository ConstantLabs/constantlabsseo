...
import { ArrowRight, ArrowUpRight, Quote, ExternalLink, Zap, Download, Play } from "lucide-react";
      ...
      <main className="pt-20">
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="sr-hero-card p-10 md:p-14">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <Link to="/smartroads/research" className="sr-btn-secondary">
                      View Research
                    </Link>
                  </div>
                </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="sr-heading-xl text-white mb-6">
                  Eliminate Traffic<br />Congestion
                </h2>
                <p className="text-[#BEBEBE] text-lg mb-10 leading-relaxed max-w-md">
              ...
              <div className="sr-card p-5">
                <div className="sr-img-box aspect-video relative mb-4">
                  <img src="/smartroads/driver_ui_stay_middle_lane.jpg" alt="Traffic Management" className="w-full h-full object-cover scale-105" />
                </div>
                <div className="sr-card p-5">
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="sr-card p-5 order-2 lg:order-1">
                <div className="sr-card p-5 mb-4 flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center bg-[#5CFF3D]/15">
                    <Zap className="w-6 h-6 text-[#5CFF3D]" />
                  </div>
                  <div>
                    <div className="text-white font-semibold">Emergency Detected</div>
                    <div className="text-xs text-[#6b6b6b]">Ambulance approaching</div>
                  </div>
                </div>
                <div className="sr-img-box aspect-video relative">
                  <img src="/smartroads/driver_ui_emergency_vehicle.jpg" alt="Emergency Response" className="w-full h-full object-cover scale-105" />
                </div>
              </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="sr-card p-5">
                <div className="sr-img-box aspect-video relative">
                  <img src="/smartroads/weather_vision_fog.jpg" alt="Weather Safety" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link to="/smartroads/research" className="rounded-[1.25rem] p-8 flex flex-col justify-between min-h-[320px] group cursor-pointer transition-all duration-300 bg-[#161616] hover:bg-[#5CFF3D]">
              ...
              <Link to="/smartroads/technology" className="rounded-[1.25rem] p-8 flex flex-col justify-between min-h-[320px] group cursor-pointer transition-all duration-300 bg-[#161616] hover:bg-[#5CFF3D]">
                <div className="flex justify-between items-start">
                  <p className="text-[#BEBEBE] leading-relaxed max-w-sm group-hover:text-black transition-colors">
        ...
        <section className="py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="sr-hero-card p-12 md:p-16 text-center">
              ...
              <p className="text-[#BEBEBE] text-lg mb-10 max-w-lg mx-auto leading-relaxed">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                <a href="/smartroads/smartroads-pitch.pdf" download className="sr-btn-secondary">
