...
const SmartRoadsStabilizingPaper = () => {
  ...
  return (
    <div className="smartroads-page min-h-screen text-white">
      <SEO
        title="SmartRoads - Stabilizing Traffic Flow Paper"
        description="Research on stabilizing traffic flow through intelligent speed advisory and cooperative driving systems."
