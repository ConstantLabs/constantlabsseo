              ...
              >
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-center">
                    <span className="mb-4 inline-block w-fit border border-line px-2.5 py-0.5 text-xs font-semibold text-ink">
                      {blogPosts[0].category}
                    </span>
                    <h2 className="mb-3 text-2xl font-bold text-ink transition-colors md:text-3xl">
                      {blogPosts[0].title}
                    </h2>
                    <p className="text-ink/70 leading-relaxed mb-6 line-clamp-3">
                      {blogPosts[0].excerpt}
                    </p>
                    ...
                    >
                      ...
                      <div className="relative h-48 overflow-hidden border border-line bg-ink">
                        {post.heroImage ? (
                          ...
                          <p className="absolute inset-0 flex items-center justify-center text-paper/70 text-sm font-medium">
                            {post.category}
                          </p>
                        )}
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="mb-2 line-clamp-2 text-lg font-bold text-ink transition-colors">
                          {post.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <ArrowRight className="h-4 w-4 text-ink/60 transition-colors group-hover:text-ink" />
                        </div>
                      </div>
                    </Link>
                  </motion.div>
