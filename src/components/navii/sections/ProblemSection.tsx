  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-6 font-rajdhani">
        ...
        >
          <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="flex-shrink-0 w-16 h-16 rounded-2xl bg-navii-orange/20 flex items-center justify-center">
              <span className="text-3xl">🗺️</span>
            </div>
            <div>
              <h3 className="text-xl font-bold text-white mb-3 font-rajdhani">The Problem</h3>
