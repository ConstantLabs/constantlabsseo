...
export const translations: TranslationMap = {
  ...
  "home.hero.title": { en: "Become the *answer* your customers find first.", ar: "كن *الإجابة* التي يجدها عملاؤك أولاً." },
  "home.hero.support": { en: "We build the authority and visibility that help brands stand out across Google and AI search.", ar: "نبني السلطة الرقمية والظهور اللذين يساعدان العلامات التجارية على التميز عبر Google ومنصات البحث بالذكاء الاصطناعي." },
  ...
  "home.hero.methodCta": { en: "See proof of our work", ar: "شاهد دليل عملنا" },
  ...
  "home.method.sequenceLabel": { en: "Search deployment sequence", ar: "تسلسل تنفيذ البحث" },
  ...
  "home.hero.parentBrand": { en: "by Constant Labs", ar: "من Constant Labs" },
  "pricing.featured": { en: "Recommended for fast growth", ar: "موصى بها للنمو السريع" },
  "pricing.timeline.aria": { en: "SEO timeline", ar: "الجدول الزمني لتحسين محركات البحث" },
  "pricing.timeline.unit": { en: "Months minimum", ar: "أشهر كحد أدنى" },
  "pricing.timeline.label": { en: "Results timeline", ar: "المدة المتوقعة للنتائج" },
  "pricing.timeline.title": { en: "SEO compounds. It is not instant.", ar: "نتائج SEO تراكمية وليست فورية." },
  "pricing.timeline.copy": {
    en: "SEO needs time to compound. Allow at least three months to see decent results. We therefore ask clients to commit to and pay for a minimum three-month campaign, while we push for measurable progress from month one.",
    ar: "يحتاج SEO إلى وقت ليتراكم أثره. امنح الحملة ثلاثة أشهر على الأقل لرؤية نتائج جيدة. لذلك نطلب من العملاء الالتزام والدفع لحملة مدتها ثلاثة أشهر كحد أدنى، بينما نعمل على تحقيق تقدم قابل للقياس منذ الشهر الأول.",
  },
  "mufakkir.metric.clicks.help": {
    en: "How many people actually clicked through to the site from Google's results.",
    ar: "عدد الأشخاص الذين نقروا فعلياً للوصول إلى الموقع من نتائج جوجل.",
  },
  "mufakkir.metric.impressions.help": {
    en: "How many times a page appeared in Google's results, whether or not it was clicked.",
    ar: "عدد المرات التي ظهرت فيها صفحة في نتائج جوجل، سواء تم النقر عليها أم لا.",
  },
  "mufakkir.metric.ctr.help": {
    en: "Clicks divided by impressions. It measures how compelling the listing is once people see it.",
    ar: "النقرات مقسومة على الظهور. يقيس مدى جاذبية النتيجة بعد أن يراها الناس.",
  },
  "mufakkir.metric.position.help": {
    en: "The average rank of the listing in Google's results. Lower is better; 1 is the top result.",
    ar: "الترتيب المتوسط للنتيجة في جوجل. الأقل أفضل، و1 هو النتيجة الأولى.",
  },
  "home.cta.railLabel": { en: "What you leave with", ar: "ما ستحصل عليه" },
  "home.cta.rail1": { en: "A technical read on what is actually holding the site back", ar: "قراءة تقنية لما يعيق الموقع فعلياً" },
  "home.cta.rail2": { en: "The competitors already taking the search traffic you want", ar: "المنافسون الذين يأخذون زيارات البحث التي تريدها" },
  "home.cta.rail3": { en: "A prioritised list, with the first fix named", ar: "قائمة مرتبة بالأولوية، مع تحديد أول إصلاح" },
  "home.cta.rail4": { en: "No pitch, and no follow-up unless you ask for one", ar: "بدون عرض بيع، وبدون متابعة إلا إذا طلبتها" },
  "home.cta.guaranteeLabel": { en: "Our guarantee", ar: "ضماننا" },
  "home.cta.guarantee": { en: "If we do not think we can help, we will tell you so and point you at someone who can.", ar: "إذا لم نعتقد أننا نستطيع المساعدة، سنقول لك ذلك ونرشدك إلى من يستطيع." },
  ...
  "mufakkir.title": { en: "From zero visibility to [[1.73K clicks]] *in six months.*", ar: "من ظهور معدوم إلى [[1.73 ألف نقرة]] *في ستة أشهر.*" },
  "mufakkir.regionLabel": { en: "Mufakkir organic search performance", ar: "أداء مَفكِّر في البحث العضوي" },
  "mufakkir.statement": {
    en: "For mufakkir.app, Google Search Console reported 1.73K organic clicks, 29.4K impressions, 5.9% CTR, and average position 8.4 over the displayed six-month period. The operating model runs SEO, GEO, and AEO together from day one.",
    ar: "بالنسبة إلى mufakkir.app، أبلغ Google Search Console عن 1.73 ألف نقرة عضوية و29.4 ألف ظهور ونسبة نقر إلى ظهور قدرها 5.9% ومتوسط ترتيب 8.4 خلال فترة الستة أشهر المعروضة."
  },
  ...
  "mufakkir.source": { en: "mufakkir.app performance report · selected 6 months", ar: "تقرير أداء mufakkir.app · الستة أشهر المحددة" },
  ...
  "pricing.title": { en: "Transparent service plans. *No hidden anything.*", ar: "باقات خدمات واضحة. *بدون أي رسوم مخفية.*" },
  ...
  "pricing.dominance.f3": { en: "Conversion-built design, so the traffic turns into enquiries", ar: "تصميم مبني على التحويل، لتحوّل الزيارات إلى استفسارات" },
  "pricing.dominance.f4": { en: "Hosting, maintenance, and content updates handled", ar: "الاستضافة والصيانة وتحديثات المحتوى مُدارة بالكامل" },
  "pricing.dominance.f5": { en: "Bilingual build, Arabic and English as one system", ar: "بناء ثنائي اللغة، العربية والإنجليزية كنظام واحد" },
  "pricing.dominance.f6": { en: "Quarterly strategy review with the founder", ar: "مراجعة استراتيجية ربع سنوية مع المؤسس" },
  "pricing.dominance.studioNote": { en: "The website is built by our sister studio", ar: "الموقع يُبنى بواسطة استوديو الويب التابع لنا" },
  "pricing.dominance.studioLink": { en: "See the website studio", ar: "شاهد استوديو المواقع" },

  // ─── Why SEO, and why it is not advertising ─────────────────
  "home.notAds.eyebrow": { en: "SEO is not advertising", ar: "SEO ليس إعلانات" },
  "home.notAds.title": { en: "Ads stop the day you stop paying. *Search does not.*", ar: "الإعلانات تتوقف يوم تتوقف عن الدفع. *البحث لا يتوقف.*" },
  "home.notAds.copy": { en: "An ad rents attention. The moment the budget pauses, the traffic is gone and nothing you paid for remains. SEO compounds instead: every page, every fix, every answer you publish keeps working after it is built.", ar: "الإعلان يستأجر الانتباه. لحظة توقف الميزانية، تختفي الزيارات ولا يبقى شيء مما دفعته. أما SEO فيتراكم: كل صفحة، وكل إصلاح، وكل إجابة تنشرها تبقى تعمل بعد بنائها." },
  "home.notAds.point1.title": { en: "It keeps going, constantly", ar: "يستمر، باستمرار" },
  "home.notAds.point1.copy": { en: "Work done in month one is still bringing people in month twelve. Nothing switches off when a campaign ends.", ar: "العمل المنجز في الشهر الأول لا يزال يجلب الناس في الشهر الثاني عشر. لا شيء يتوقف عند انتهاء حملة." },
  "home.notAds.point2.title": { en: "It is relevance, not interruption", ar: "إنه ملاءمة، لا مقاطعة" },
  "home.notAds.point2.copy": { en: "Nobody was interrupted. They asked a question and your business was the answer, which is why they arrive ready.", ar: "لم يُقاطع أحد. لقد طرحوا سؤالاً وكان عملك هو الإجابة، ولهذا يصلون وهم مستعدون." },
  "home.notAds.point3.title": { en: "It is your digital storefront", ar: "إنه واجهة متجرك الرقمية" },
  "home.notAds.point3.copy": { en: "Search is where people decide whether you exist. Being absent there is a closed shutter on the busiest street in the city.", ar: "البحث هو المكان الذي يقرر فيه الناس ما إذا كنت موجوداً. الغياب عنه كأنه باب مغلق في أكثر شوارع المدينة حركة." },
